...
const startServer = async () => {
  ...
  const resolvers = {
    ...
    ...(cartResolvers.Cart ? { Cart: cartResolvers.Cart } : {}),
    ...(cartResolvers.CartItem ? { CartItem: cartResolvers.CartItem } : {}),
    ...(membershipResolvers.Membership ? { Membership: membershipResolvers.Membership } : {}),
  };
