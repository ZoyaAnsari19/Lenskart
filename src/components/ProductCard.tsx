      ...
      <div className="relative">
        ...
        {product.isNewArrival && (
          <div className="absolute top-2 left-2 bg-gradient-to-r from-purple-500 to-pink-500 
                          text-white px-2 py-1 rounded-full text-xs font-semibold flex items-center gap-1 z-20">
        ...
        <button
          onClick={(e) => {
            e.stopPropagation();
            const productName =
              product.name || product.brand || product.category || "Product";
            if (inWishlist) {
        ...
        <img
          ...
          className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-300 relative z-0"
        />
      </div>
